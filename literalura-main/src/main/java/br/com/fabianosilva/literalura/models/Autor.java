package br.com.fabianosilva.literalura.models;
...
public class Autor {
    ...
    List<br.com.fabianosilva.literalura.models.Livro> livros = new ArrayList<>();

    public Autor() {}

    public Autor(br.com.fabianosilva.literalura.models.AutorDados autorDados) {
    ...
    public List<br.com.fabianosilva.literalura.models.Livro> getLivros() {
        return livros;
    }

    public void setLivros(List<br.com.fabianosilva.literalura.models.Livro> livros) {
        this.livros = livros;
    }
